...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> addBooking(BookingDto booking, long userId) {
    ...
    public ResponseEntity<Object> getBookingByItems(BookingState state, long userId, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
