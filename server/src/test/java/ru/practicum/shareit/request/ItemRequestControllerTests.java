...
public class ItemRequestControllerTests {
    ...
    public void getAllUserRequestsTest() throws Exception {
        ...
        checkItemRequestListProp(mockMvc.perform(get("/requests").header(USER_ID_HEADER, 1L)));
    }
    ...
    public void addRequestTest() throws Exception {
        ...
        checkItemRequestProp(mockMvc.perform(postJson("/requests", request).header(USER_ID_HEADER, 1L)));
    }
    ...
    public void findAllRequestsTest() throws Exception {
        ...
        checkItemRequestListProp(mockMvc.perform(get("/requests/all").header(USER_ID_HEADER, 1L)));
    }
    ...
    private static void checkItemRequestProp(ResultActions request) throws Exception {
    ...
    private static void checkItemRequestListProp(ResultActions request) throws Exception {
        request.andExpect(status().isOk())
