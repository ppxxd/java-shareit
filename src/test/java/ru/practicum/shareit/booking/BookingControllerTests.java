...
public class BookingControllerTests {
    ...
    public void getAllByUser() {
        when(bookingService.getAllByUser(1L, BookingState.ALL, 0, 10))
    ...
    public void getBookingsByItemsTest() {
        when(bookingService.getBookingsByItems(1L, BookingState.ALL, 0, 10))
                .thenReturn(List.of(bookingResult));
    ...
    public void checkValid() {
        InvalidDataException exception = assertThrows(InvalidDataException.class, () ->
                bookingService.getAllByUser(1L, BookingState.convert("TEST"), 0, 10));

        assertThat(exception.getMessage(), is("Unknown state: TEST"));
    }
