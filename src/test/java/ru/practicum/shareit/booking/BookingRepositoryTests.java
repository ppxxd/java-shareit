...
@DataJpaTest
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_EACH_TEST_METHOD) //Чтобы чистить репозиторий
public class BookingRepositoryTests {
    ...
    public void findFirstByItemIdAndStatusAndStartAfterOrderByStartTest() {
        Booking result = bookingRepository.findFirstByItemIdAndStatusAndStartAfterOrderByStart(1L,
                BookingStatus.WAITING, CURRENT_TIME);
