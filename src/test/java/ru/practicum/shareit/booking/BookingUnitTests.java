...
public class BookingUnitTests {
    ...
    public void addBooking_AndExpectError() {
        ...
        ObjectCreateException exception = assertThrows(ObjectCreateException.class, () ->
                bookingService.addBooking(BookingMapper.bookingToDto(booking), 1L));

        assertThat(exception.getMessage(), is("Время окончания бронирования не может быть после/равным началу!"));
    }
    ...
    public void addBooking_AndExpectAccessException() {
        ...
        assertThat(exception.getMessage(), is("Вы не можете забронировать свои вещи!"));
    }
    ...
    public void approveBooking_AndExpectAvailabilityException() {
        ...
        assertThat(exception.getMessage(), is("Бронь уже APPROVED"));
    ...
    public void getAllByUserTest() {
        ...
        List<BookingDto> result = bookingService.getAllByUser(1L, BookingState.ALL, 0, 10);
